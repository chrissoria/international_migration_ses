...
\textbf{Table 1 observations:}

\begin{itemize}
\item
  \textbf{Mexico has the highest percentage of migrants to the U.S. at
  43.99\%.}
\item
...
\item
  \textbf{Our four countries of interest are the biggest migrant groups}
\item
  \textbf{Puerto Rico leads with a GDP per capita of \$36,779, which is
  much higher than other countries in the dataset.}
\item
  Haiti has the lowest GDP per capita at \$1,705
\item
  Haiti had an extremely high infant mortality rate of 237.19 deaths per
  1,000 live births in 1950
\item
...
\item
  ...
  1,000
\item
  \textbf{The Dominican Republic has the lowest infant mortality rate in
  2019 at just 4.14 deaths per 1,000}
\item
  Costa Rica (24.52 years) and Chile (24.57 years) have relatively high
  life expectancy at age 60
\item
  Haiti has the lowest life expectancy at age 60
\item
  \textbf{Of our four countries:}

  \begin{itemize}
  \item
    \textbf{Mexico contributes the largest number of migrants and has a
    relatively high GDP per capita (\$13,790) but also a higher infant
    mortality rate in 2019 (10.79) compared to countries like Cuba
    (4.89).}
  \item
    \textbf{The Dominican Republic has the lowest number of migrants
    (only 6.04\% of the total).}
  \item
    \textbf{Cuba has the lowest GDP per capita at \$9,605}
  \item
    \textbf{Mexico has the highest infant mortality rate}
  \item
...
\bibitem[\citeproctext]{ref-noauthor_cme_2025}
...
\bibitem[\citeproctext]{ref-noauthor_global_2021}
