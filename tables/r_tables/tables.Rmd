...
in_df <- read_dta(paste0(data_dir,"UsPrMe_10_20.dta"))
...
combined_table <- combined_table %>%
  ...
  select(Gender, variable, `dominican republic`, mexico, `puerto rico`,`foreign-born hispanic`, `foreign-born not hispanic`, `native-born hispanic`, `native-born not hispanic`) %>% 
  rename(
