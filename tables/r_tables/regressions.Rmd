...
for (dv in dvs) {
  m1 <- tidy(results_all_2020[[dv]]) %>% mutate(model = "no_controls_all", n = nobs(results_all_2020[[dv]]))
  m2 <- tidy(country_coefs_2020[[dv]]) %>% mutate(model = "all_controls_all", n = nobs(country_coefs_2020[[dv]]))
  m3 <- tidy(results_female_2020[[dv]]) %>% mutate(model = "no_controls_female", n = nobs(results_female_2020[[dv]]))
  m4 <- tidy(female_country_coefs_2020[[dv]]) %>% mutate(model = "all_controls_female", n = nobs(female_country_coefs_2020[[dv]]))
  m5 <- tidy(results_male_2020[[dv]]) %>% mutate(model = "no_controls_male", n = nobs(results_male_2020[[dv]]))
  m6 <- tidy(male_country_coefs_2020[[dv]]) %>% mutate(model = "all_controls_male", n = nobs(male_country_coefs_2020[[dv]]))
...
```{r}
for (dv in dvs) {
  m1 <- tidy(results_all_2010[[dv]]) %>% mutate(model = "no_controls_all", n = nobs(results_all_2010[[dv]]))
  m2 <- tidy(country_coefs_2010[[dv]]) %>% mutate(model = "all_controls_all", n = nobs(country_coefs_2010[[dv]]))
  m3 <- tidy(results_female_2010[[dv]]) %>% mutate(model = "no_controls_female", n = nobs(results_female_2010[[dv]]))
  m4 <- tidy(female_country_coefs_2010[[dv]]) %>% mutate(model = "all_controls_female", n = nobs(female_country_coefs_2010[[dv]]))
  m5 <- tidy(results_male_2010[[dv]]) %>% mutate(model = "no_controls_male", n = nobs(results_male_2010[[dv]]))
  m6 <- tidy(male_country_coefs_2010[[dv]]) %>% mutate(model = "all_controls_male", n = nobs(male_country_coefs_2010[[dv]]))
