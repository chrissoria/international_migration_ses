...
create_faceted_demo_plot <- function(data, 
  ...
  ggplot(data_long, aes(x = .data[[country_var]], y = mean_value, 
    ...
    scale_alpha_manual(name = "Type", 
                       values = c("Unadjusted" = 1, "Adjusted" = 0.5),
...
create_faceted_demo_plot2 <- function(data, 
  ...
  # Create plot with black and white bars
  ggplot(data_long, aes(x = .data[[country_var]], y = mean_value, 
                        fill = type)) +
    ...
    scale_fill_manual(name = "Type", 
                      values = c("Unadjusted" = "white", "Adjusted" = "black")) +
    scale_y_continuous(breaks = seq(0, 1, 0.25), limits = y_limits) +
    labs(
      title = title,
      x = NULL,
      y = "Proportion"
...
raw_and_adjusted_df <- create_country_summary(us_df_2020, country_coefs = country_coefs)
...
country_levels
country_levels_male
country_levels_female

country_levels <- create_faceted_demo_plot2(results$all,
                                           y_limits = c(0, .99))

country_levels_male <- create_faceted_demo_plot2(results$male,
                                           y_limits = c(0, .99))

country_levels_female <- create_faceted_demo_plot2(results$female,
                                           y_limits = c(0, .99))
