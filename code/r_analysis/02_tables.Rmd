...
## Reference population: US 2010 Census Hispanics 60+ (by sex).
## Age distribution rows reflect the reference population, not the original country distributions.
```{r}
# Use age-standardized weights for US data to match international data
